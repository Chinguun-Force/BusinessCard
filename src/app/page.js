...
export default function Home() {
  ...
  // return (
  //   <div className='flex justify-self-center items-center gap-12'>
  //     <h1 className='text-xl '>{counter}</h1>
  //     <button onClick={incrementCounter} className='bg-cyan-300 p-[12px] rounded-xl'>increment Counter</button>
  //     <button onClick={decrementCounter} className='bg-cyan-300 p-[12px] rounded-xl'>decrement Counter</button>
  //   </div>
  // );
}